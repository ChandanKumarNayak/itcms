...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Custom Export: Purchase History | IT-CMS</title>
...
$vendor = $_POST['vendor'];
$getdata=("SELECT * FROM `purchase` WHERE vendor ='$vendor' ORDER BY date_of_purchase DESC,id DESC");
...
header('Content-Disposition:attachment;filename='.$vendor.'_it asset purchase_'.$date.'.xls');
echo $html;
exit;
}
else {
