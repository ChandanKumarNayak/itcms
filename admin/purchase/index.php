...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Purchase History | IT-CMS</title>
...
<div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <?php if($_SESSION['role']==1){?>
        ...
        <a href="index.php" class="list-group-item list-group-item-action bg-light" style="color:blue;">Purchase History <i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>
...
<!--END FETCH-->        
  ...
  <a class="nav-link" data-toggle="modal" type="button" data-target="#addPurchase"><i class="fa fa-plus"></i>&nbsp;add</a>
  <div class="dropdown">
...
if($result_purchase = mysqli_query($db, $getdata))
...
{ 
 ...
 if($date_of_purchase==''){
 $date_of_purchase_IN= date("00-00-0000");
 }else{
 $date_of_purchase_IN= date("d-m-Y", strtotime($date_of_purchase));
 }
 ...
 $bill_clear_date_IN= date("d-m-Y", strtotime($bill_clear_date));
  ...
  echo "<tr>";
echo "<td>" . $i++ . "</td>";
echo "<td>" . $row['asset_details'] . "</td>";
echo "<td>" . $row['serial_no'] . "</td>";
echo "<td>" . $row['user'] . "</td>";
echo "<td>$date_of_purchase_IN</td>";
...
echo '<td><a class="button-change button-blue" data-toggle="modal" type="button" data-target="#update_purchase'.$row['id'].'"><i class="fa fa-edit"></i>&nbsp;Edit</a></td>';
