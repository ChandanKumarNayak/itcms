...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Custom Export: Catriedge Service | IT-CMS</title>
...
$vendor = $_POST['vendor'];
$getdata=("SELECT * FROM `catriedge` WHERE vendor ='$vendor' ORDER BY service_date DESC,id DESC");
...
header('Content-Disposition:attachment;filename='.$vendor.'_catriedge service_'.$date.'.xls');
echo $html;
exit;
}
else {
