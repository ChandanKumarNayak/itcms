...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>IT Asset Repair Service | IT-CMS</title>
...
<div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <?php if($_SESSION['role']==1){?>
        ...
        <a href="index.php" class="list-group-item list-group-item-action bg-light" style="color:blue;">IT Asset Repair Service <i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>
...
<!--END FETCH-->        
  ...
  <a class="nav-link" data-toggle="modal" type="button" data-target="#addRepair"><i class="fa fa-plus"></i>&nbsp;add</a>
  <div class="dropdown">
...
if($result_repair = mysqli_query($db, $getdata))
...
echo "<thead>";
  echo "<tr>
   ...
   echo "</thead>";
while($row = mysqli_fetch_assoc($result_repair))
{ 
...
echo '<td><a class="button-change button-blue" data-toggle="modal" type="button" data-target="#update_repair_details'.$row['id'].'"><i class="fa fa-edit"></i>&nbsp;Edit</a></td>';
