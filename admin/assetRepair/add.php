...
$sql="INSERT INTO `assetrepair` (system_type,serial_no,user,vendor,service_date,repair_details,bill_no,cheque_no,bill_clear_date,total_cost) VALUES ('$system_type' ,'$serial_no','$user' ,'$vendor' ,'$service_date' ,'$repair_details' ,'$bill_no' ,'$cheque_no' ,'$bill_clear_date' ,'$total_cost')"; 
if($result = mysqli_query($db, $sql))
$assetrepair_id = mysqli_insert_id($db);
// Expense
$sql_expense="INSERT INTO `expense` (details,user,vendor,service_date,bill_no,cheque_no,bill_clear_date,cost,assetrepair_id,company,from_date,till_date,catriedge_id,purchase_id) VALUES ('$repair_details','$user' ,'$vendor' ,'$service_date' ,'$bill_no' ,'$cheque_no' ,'$bill_clear_date' ,'$total_cost','$assetrepair_id','$company','$from_date','$date',0,0)"; 
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
 ...
 <body>
 <!-- ADD REPAIR DETAILS -->
 <div class="modal fade" id="addRepair" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
